...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Generate line art from images")
    parser.add_argument("project", type=str, help="Title of project to parse")
